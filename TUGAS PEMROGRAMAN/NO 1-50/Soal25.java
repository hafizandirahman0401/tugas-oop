...
public class Soal25 {
    // Tahun kabisat dari n_awal s.d n_akhir yang angka terakhirnya 2
    public static void main(String[] args) {
        ...
        System.out.println("Tahun kabisat (akhiran 2) dari " + nAwal + " sampai " + nAkhir + ":");
        for (int tahun = nAwal; tahun <= nAkhir; tahun++) {
            boolean kabisat = (tahun % 4 == 0 && tahun % 100 != 0) || (tahun % 400 == 0);
            if (kabisat && tahun % 10 == 2) {
